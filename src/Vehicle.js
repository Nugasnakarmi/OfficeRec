                    ...
                    <div class="col-md-4  mb-3">
                        ...
                        <select disabled={this.state.editable ? "" : "disabled"} id="drop-vehicle" onChange={this.handleSelectChange} name='type' value={this.state.type} className="custom-select">
                            <optgroup label='Category I'>
                                ...
                                <option value='TwoWheeler'>Motorcycle/Scooter</option>
                ...
                <form >
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input disabled value={this.state.dueDate} className="form-control-plaintext" id="inputDate" name="dueDate" type="text" onChange={this.handleChange}></input>
                        </div>
                        <div class="col-md-6 mb-3">
